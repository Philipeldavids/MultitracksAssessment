				...
				<div class="details-banner">
					...
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
							<asp:Image ID="Image2" runat="server" class="details-banner--info--box--img" />
								<%--<img class="details-banner--info--box--img"
								 src="./PageToSync/img/174.jpg"
								 srcset="./PageToSync/img/174.jpg,
				...
				<nav class="discovery--nav">
					<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
						<li class="discovery--nav--list--item tab-filter--item is-active">
							<a class="tab-filter" href="../artistDetailsPage.aspx">Overview</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="../artistDetailsPage.aspx">Songs</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="../artistDetailsPage.aspx">Albums</a>
						</li>
							...
							<main class="discovery--section">
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												<asp:Image ID="Image3" runat="server" class="song-list--item--player-img--img" />
										...
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												<asp:Image ID="Image12" runat="server" class="song-list--item--player-img--img" />
												<%--<img class="song-list--item--player-img--img" 
												srcset="./PageToSync/img/2822.jpg 2x" 
												src="./PageToSync/img/2822.jpg" alt="Way Maker">--%>
											</div>
										...
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												<asp:Image ID="Image13" runat="server" class="song-list--item--player-img--img" />
												<%--<img class="song-list--item--player-img--img" 
												srcset="./PageToSync/img/2822.jpg 2x" 
												src="./PageToSync/img/2822.jpg" alt="Way Maker">--%>
											</div>
											...
											<div class="ly-grid ly-grid-cranberries">
												...
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">	
														<asp:Image ID="Image4" runat="server" class="media-item--img"/>
													...
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle4" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image5" runat="server" class="media-item--img"/>
														<%--<img class="media-item--img" alt="Reckless Love" src="./PageToSync/img/210.jpg" srcset="./PageToSync/img/210.jpg, ./PageToSync/img/210.jpg 2x">--%>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle5" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image6" runat="server" class="media-item--img"/>
														<%--<img class="media-item--img" alt="Reckless Love" src="./PageToSync/img/210.jpg" srcset="./PageToSync/img/210.jpg, ./PageToSync/img/210.jpg 2x">--%>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle6" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																	</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image7" runat="server" class="media-item--img"/>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle7" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image8" runat="server" class="media-item--img"/>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle8" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image9" runat="server" class="media-item--img"/>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle9" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image10" runat="server" class="media-item--img"/>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle10" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
												<div class="media-item">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image ID="Image11" runat="server" class="media-item--img"/>
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><asp:Literal ID="SongTitle11" runat="server" /></a>
													<a class="media-item--subtitle" href="#" tabindex="0">ISRAEL HOUGHTON</a>
												</div>
											</div><!-- /.grid -->
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<asp:Literal runat="server" id="biography"></asp:Literal>
										<p></p>
										<a href="#">Read More...</a>
									</div>
